...
const button = tv({
  ...
  variants: {
    ...
    variant: {
      ...
      inverse: "shadow-xs border-transparent bg-background text-foreground hover:bg-background-hover",
      "inverse-ghost": "border-transparent bg-transparent text-background hover:bg-background/10",
