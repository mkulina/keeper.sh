...
const PROVIDERS: Provider[] = [
  {
    ...
    description: "Connect your Google Calendar to push aggregated events using secure OAuth authentication.",
    steps: [
      {
      ...
      },
      {
        ...
        description: "Allow Keeper to write events to your calendar.",
      },
    ],
  ...
  },
  {
    ...
    description: "Connect your Outlook or Microsoft 365 calendar to push events using secure OAuth authentication.",
    steps: [
      {
  ...
  },
  {
    ...
    description: "Connect your iCloud Calendar to push events using an app-specific password.",
    steps: [
      {
      ...
      },
      {
        ...
        description: "Choose which iCloud calendar you want to push events to.",
      },
    ],
  ...
  },
  {
    ...
    description: "Connect your Fastmail calendar to push events using an app password.",
    steps: [
      {
      ...
      {
        title: "Select calendar",
        description: "Choose which Fastmail calendar you want to push events to.",
      },
    ],
  ...
  },
  {
    ...
    name: "CalDAV",
    icon: null,
    description: "Connect any CalDAV-compatible calendar server to push events.",
    steps: [
      {
      ...
      {
        title: "Select calendar",
        description: "Choose which calendar from this server you want to push events to.",
      },
    ],
